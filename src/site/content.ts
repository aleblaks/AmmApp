...
// TODO: contenuti copiati da AirportShift con solo il nome sostituito — rivedi
// le sezioni specifiche (PDF turni, QR, permessi fotocamera/calendario) per
// adattarle alle vere funzionalità di Balance Life prima della pubblicazione.
const balancelife: AppPrivacy = {
  ...
  docs: {
    it: {
      ...
      lastUpdated: 'Ultimo aggiornamento: 23 giugno 2026',
      intro:
        "Balance Life è un'app pensata per gestire i tuoi turni di lavoro. La tua privacy è una priorità: l'app funziona interamente sul tuo dispositivo e non raccoglie alcun dato personale.",
      sections: [
        {
          heading: 'Nessuna raccolta dati',
          paragraphs: [
    ...
    en: {
      ...
      lastUpdated: 'Last updated: 23 June 2026',
      intro:
        'Balance Life is an app designed to manage your work shifts. Your privacy is a priority: the app runs entirely on your device and does not collect any personal data.',
      sections: [
        {
          heading: 'No data collection',
          paragraphs: [
...
// TODO: contenuti copiati da AirportShift con solo il nome sostituito — rivedi
// le FAQ (import PDF, QR, permessi) per adattarle alle vere funzionalità di
// Balance Life prima della pubblicazione.
